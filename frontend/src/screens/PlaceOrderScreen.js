...
import { cleanCart, getCartItems, getPayment, getShipping, getUserInfo } from "../localStorage";
...
const PlaceOrderScreen ={
    after_render: async () =>{
        ...
        .addEventListener("click", async ()=>{
            ...
            const order = {...orderItems,...user}
            showLoading();
            const data =  await createOrder(order);
            const data1 = await placeOrder(order);
            hideLoading();
            if(data.error || data1.error){
                ...
                <div class="order-info">
                        ...
                        <ul class="cart-list-container">
                            ...
                            ${orderItems.map(
                                ...
                                <div class="cart-image">
                                    <img src="${`data:image/jpg;base64,${btoa(String.fromCharCode(...new Uint8Array((item.image.data.data))))}`}" alt="${item.name}" alt="${item.name}" alt="${item.name}">
                                </div>
                                <div class="cart-name">
                                    <div>
                    ...
                    <div class="order-action">
                        <ul>
                            ...
                            <li><div class="total">Order Total</div><div class="total">N$${totalPrice}</div></li>
                            <li>
